...
def main():
    ...
    r7= 100  
    r8= 50  
    A = np.array([[1, 0, 0, 0, 0], [1/r1, -(r2*r5+r1*r5+r1*r2)/(r1*r2*r5), 0, 0, 1/r2], [0, 1/r2, -(r3*r6+r2*r6+r2*r3)/(r2*r3*r6), 1/r3, 0],[0, 0, 1/r3, -(r4*r7+r3*r7+r3*r4)/(r3*r4*r7), 1/r4],[0, 0, 0, 1/r4, -(r8+r4)/(r8*r4)]], dtype=float)
    ...
    X = seidel(A, B, 100, 1e-8)
    print(X)
    print("-- Atividade 4 a reduzido --")
    A = np.array([[-(r2*r5+r1*r5+r1*r2)/(r1*r2*r5), 0, 0, 1/r2], [ 1/r2, -(r3*r6+r2*r6+r2*r3)/(r2*r3*r6), 1/r3, 0],[ 0, 1/r3, -(r4*r7+r3*r7+r3*r4)/(r3*r4*r7), 1/r4],[ 0, 0, 1/r4, -(r8+r4)/(r8*r4)]], dtype=float)
    B = np.array([ -127/r1, 0, 0, 0], dtype=float)
    print("Matriz A:")
    print(A)
    print("\nVetor B:")
    print(B)
